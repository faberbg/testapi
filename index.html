            ...
            switch ( $("input[name=http_zahtev]:checked")[0].id){
                ...
                //proveravamo koja je tabela
                    if(tabela=="radio_novosti"){
                        ...
                        $.getJSON("http://localhost:8080/git/rest/api/novosti", function(data){
                        ...
                        $.getJSON("http://localhost:8080/git/rest/api/kategorije", function(data){
                            document.getElementById("get_odgovor").innerHTML = JSON.stringify(data,null,2);
                        });
                    }
                    break;
                ...
                // prikupimo podatke koje hoćemo da pošaljemo iz forme
                        ...
                        $.post("http://localhost:8080/git/rest/api/novosti", JSON.stringify(values),function(data){
                        ...
                        console.log(values);
                        $.post("http://localhost:8080/git/rest/api/kategorije", JSON.stringify(values),function(data){
                            alert("Odgovor od servera> "+data['poruka']);
                        });
                ...
                case "put":
                        if(tabela=="radio_novosti"){
                            ...
                            "kategorija_id": parseInt($("#kategorija_odabir_put").val())
                             ...
                             console.log(values);
                            $.ajax({
                            url:"http://localhost:8080/git/rest/api/novosti/"+value1.id, 
                            type: 'PUT',
                            data:JSON.stringify(values),
                            success: function(data) {
                                    alert("apdejt uspesan za put novosti");
                        }
                             });
                        }else{
                            var value1 ={
                            ...
                            var values ={
                              ...
                              $.ajax({
                            url:"http://localhost:8080/git/rest/api/kategorije/"+value1.id, 
                            type: 'PUT',
                            data:JSON.stringify(values),
                            success: function(data) {
                                    alert("apdejt uspeo za put kategorju");
                        }
                             });
                ...
                case "delete":
                    if(tabela=="radio_novosti"){
                        ...
                        var values ={
                                "novosti_id": $("input[name=brisanje]").val(),
                              };
                              console.log(values);
                        $.ajax({
                            url:"http://localhost:8080/git/rest/api/novosti/"+values.novosti_id, 
                            type: 'DELETE',
                            success: function() {
                                    alert("Izbrisano");
                        }
                        ...
                        var values ={
                                "kategorija_id": $("input[name=brisanje]").val(),
                              };
                              console.log(values);
                        $.ajax({
                            url:"http://localhost:8080/git/rest/api/kategorije/"+values.kategorija_id, 
                            type: 'DELETE',
                            success: function() {
                                    alert("Izbrisano");
                        }
